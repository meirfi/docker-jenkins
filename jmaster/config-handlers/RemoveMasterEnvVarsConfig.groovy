...
<html lang="en">
  ...
  <title>my-bloody-jenkins/RemoveMasterEnvVarsConfig.groovy at master · shelleg/my-bloody-jenkins · GitHub</title>
  ...
  <meta name="request-id" content="9216:433F:16875BF:2BA709D:5B6C9202" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="9216:433F:16875BF:2BA709D:5B6C9202" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="OWVhYjFkMmI1ZWFmOTA5MDA5NTQ0NDAwNDc0NDk4ZThkZmQzMmRjOWE4ODQyZmRkNzBkMjUwYzc2MDRjYzk0ZHx7InJlbW90ZV9hZGRyZXNzIjoiMzQuMjQ0Ljg1Ljc5IiwicmVxdWVzdF9pZCI6IjkyMTY6NDMzRjoxNjg3NUJGOjJCQTcwOUQ6NUI2QzkyMDIiLCJ0aW1lc3RhbXAiOjE1MzM4NDE5MjIsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="e4ad2297e7f25ca1803fc1da70d984a91c7b15d3">
  ...
  <meta name="octolytics-dimension-user_id" content="19572046" /><meta name="octolytics-dimension-user_login" content="shelleg" /><meta name="octolytics-dimension-repository_id" content="130461052" /><meta name="octolytics-dimension-repository_nwo" content="shelleg/my-bloody-jenkins" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="true" /><meta name="octolytics-dimension-repository_parent_id" content="102985641" /><meta name="octolytics-dimension-repository_parent_nwo" content="odavid/my-bloody-jenkins" /><meta name="octolytics-dimension-repository_network_root_id" content="102985641" /><meta name="octolytics-dimension-repository_network_root_nwo" content="odavid/my-bloody-jenkins" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/shelleg/my-bloody-jenkins/blob/master/config-handlers/RemoveMasterEnvVarsConfig.groovy" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="130461052" data-scoped-search-url="/shelleg/my-bloody-jenkins/search" data-unscoped-search-url="/search" action="/shelleg/my-bloody-jenkins/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=bgrWErdetMKO4uQyh0gMK7wG+j1+YH70swBqI2dviFFd64fLIxS0j0l+Gm2gDx6z4GFCNSyCn76hE2aJh7puaw=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <a class="HeaderMenu-target text-white no-underline mr-3" href="/login?return_to=%2Fshelleg%2Fmy-bloody-jenkins%2Fblob%2Fmaster%2Fconfig-handlers%2FRemoveMasterEnvVarsConfig.groovy" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:dropdowns">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/shelleg/my-bloody-jenkins/blob/8e11f5e8a639dd7664f34f8d7faec769b23cc66b/config-handlers/RemoveMasterEnvVarsConfig.groovy">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:aef67a3226e5d80b29a3d433fbeb27dd -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="V+nxGqawHSPfwkadcrcQ3hJPIDGPQsYy28n8Aw4JDzlQ05aU4Esddf+aWbo2AZcvCuaOxZ5XD37upImFDMw2iw==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/shelleg/my-bloody-jenkins/blob/cac-plugin/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/shelleg/my-bloody-jenkins/blob/master/config-handlers/RemoveMasterEnvVarsConfig.groovy"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.2-36/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.2-35/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.2-34/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.2-33/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.2-32/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-31/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-30/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-29/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-28/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-27/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-26/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.107.1-25/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.4-24/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.4-23/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.4-22/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.4-21/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.4-20/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.3-19/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.3-18/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.3-17/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.3-16/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.3-15/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.2-14/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.2-13/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.2-12/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.2-11/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.2-10/config-handlers/RemoveMasterEnvVarsConfig.groovy"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.1-9/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.89.1-9"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.1-8/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.89.1-8"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.89.1-7/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.89.1-7"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-6/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-6"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-5/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-5"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-4/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-4"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-3/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-2/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/shelleg/my-bloody-jenkins/tree/v2.73.3-1/config-handlers/RemoveMasterEnvVarsConfig.groovy"
              data-name="v2.73.3-1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/shelleg/my-bloody-jenkins/raw/master/config-handlers/RemoveMasterEnvVarsConfig.groovy">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/shelleg/my-bloody-jenkins/blame/master/config-handlers/RemoveMasterEnvVarsConfig.groovy">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/shelleg/my-bloody-jenkins/commits/master/config-handlers/RemoveMasterEnvVarsConfig.groovy">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-groovy">
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">hudson.EnvVars</span><span class="pl-k">.</span>masterEnvVars</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">        .findAll{<span class="pl-v">k</span>,<span class="pl-v">v</span> <span class="pl-k">-&gt;</span> config<span class="pl-k">.</span>findAll{k <span class="pl-k">==~</span> it}}</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">        .keySet()</td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">        .each{<span class="pl-k">hudson.EnvVars</span><span class="pl-k">.</span>masterEnvVars<span class="pl-k">.</span>remove(it)}</td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/shelleg/my-bloody-jenkins/blame/8e11f5e8a639dd7664f34f8d7faec769b23cc66b/config-handlers/RemoveMasterEnvVarsConfig.groovy">View git blame</a></li>
      </ul>
    </details-menu>
  </details>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.30493s from unicorn-574fcd9f6f-w98wh">GitHub</span>, Inc.</li>
